...
void lcd_draw_picture_t(esp_lcd_panel_t *panel,uint16_t *pixels)
{
    ...
    memcpy(pixels, gImage_img_640_12, (640 * 12) * sizeof(uint16_t));
    for(int i =0;i<480;i=i+12)
        esp_lcd_panel_draw_bitmap(panel, 0, i, 640, 12+i, (uint16_t *)pixels);
...
static const unsigned char gImage_img_640_12[15360] =  { /* 0X00,0X10,0X78,0X00,0X27,0X00,0X01,0X1B, */ //BRG 565
